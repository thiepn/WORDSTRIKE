...
assert.equal(moveSpeedTestSetupSelection("time-60", "ArrowUp"), "time-30");
assert.equal(moveSpeedTestSetupSelection("time-120", "ArrowDown"), "time-15");
assert.equal(moveSpeedTestSetupSelection("time-60", "ArrowRight"), "words-50");
assert.equal(moveSpeedTestSetupSelection("words-50", "Tab"), "time-60");

console.log("Typing Test configuration validation, defaults, query parsing, and setup navigation tests passed.");
